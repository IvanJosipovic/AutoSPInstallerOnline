...
angular.module("ASPIO", ["ngRoute", "ngMessages", "customDirectives", "ui.bootstrap"])
    ...
    .config(function ($routeProvider, $locationProvider) {
        $routeProvider
            .when("/", {
                ...
                templateUrl: "App/Partials/_homePartial.html",
    ...
    .service("xmlService", function () {
        this.config = null;
        this.context = new Jsonix.Context([ConfigModel3995]);
    ...
    .controller("Controller", ["$scope", "xmlService", function ($scope, xmlService) {
        ...
        $scope.loadXML = function (xml: string) {
            try {
                ...
                if (xml.indexOf("Version='3.99.5'") !== -1 || xml.indexOf("Version=\"3.99.5\"") !== -1) {
                    xmlService.LoadXml(xml);
                } else if (xml.indexOf("Version='3.99'") !== -1 || xml.indexOf("Version=\"3.99\"") !== -1) {
                    xmlService.UpgrdeXml399to3995(xml);
                    ...
                    xml = xmlService.UpgrdeXml398to399(xml);
                    xmlService.UpgrdeXml399to3995(xml);
    ...
    .controller("BlankController", ["$scope", "xmlService", function ($scope, xmlService) {
        $scope.config = xmlService.config;
