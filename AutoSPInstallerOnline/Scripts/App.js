    ...
    .controller("Controller", ["$scope", "xmlService", function ($scope, xmlService) {
        ...
        $scope.loadXML = function (xml) {
            try {
                ...
                if (xml.indexOf("Version='3.99.51'") !== -1 || xml.indexOf("Version=\"3.99.51\"") !== -1) {
                    xmlService.LoadXml(xml);
                }
                else if (xml.indexOf("Version='3.99.5'") !== -1 || xml.indexOf("Version=\"3.99.5\"") !== -1) {
                    xmlService.UpgrdeXml3995to39951(xml);
                    ...
                    xml = xmlService.UpgrdeXml399to3995(xml);
                    xmlService.UpgrdeXml3995to39951(xml);
